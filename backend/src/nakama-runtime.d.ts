declare namespace nkruntime {
  ...
  interface Nakama {
    ...
    leaderboardCreate(id: string, authoritative: boolean, sortOrder?: string, operator?: string, resetSchedule?: string, metadata?: object, enableRanks?: boolean): void;
    leaderboardDelete(ctx: Context, id: string): void;
    leaderboardRecordDelete(ctx: Context, id: string, ownerId: string): void;
    leaderboardRecordWrite(id: string, ownerId: string, username?: string, score?: number, subscore?: number, metadata?: object, operator?: string): LeaderboardRecord;
  ...
  interface StorageObject {
    ...
    key: string;
    userId: string;
    /** Parsed object from the server runtime, or JSON string depending on context */
